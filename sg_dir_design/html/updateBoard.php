...
<head>
	...
	<script>
		...
		function summit() {
			...
			httpRequest.open('post', '../php/Board_process.php?mode=update', true);
...
<body>
	...
	<div class="write_head">게시글 수정</div>
	<div>
		...
		<div class="title_group">
			...
			<input class="title_input" id="title" type="text" name="title" value="<?= $row['title'] ?>" required>
		</div>
		<!-- summernote 에디터 -->
		<textarea id="summernote" name="content"><?= $row['content'] ?></textarea>
		<div class="write_button_wrapper">
			<button class="write_edit_button" onclick="summit()">수정하기</button>
